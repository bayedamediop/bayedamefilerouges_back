 ...
 */
final class Version20210119210021 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE referentiels ADD CONSTRAINT FK_590B3B47A660B158 FOREIGN KEY (competences_id) REFERENCES competence (id)');
